output "vpc_id" {
  ...
  value       = var.vpc_id == "" ? aws_vpc.this.*.id[0] : var.vpc_id 
}
...
#   value       = concat(data.aws_vpc.this.*.default_security_group_id, [""])[0]
# }

# output "default_network_acl_id" {
#   description = "The ID of the default network ACL"
#   value       = concat(data.aws_vpc.this.*.default_network_acl_id, [""])[0]
# }

# output "default_route_table_id" {
#   description = "The ID of the default route table"
#   value       = concat(data.aws_vpc.this.*.default_route_table_id, [""])[0]
# }
...
#   value       = concat(data.aws_vpc.this.*.owner_id, [""])[0]
# }
