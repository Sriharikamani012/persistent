/*************************************************************************
  DO NOT EDIT THIS FILE IT WILL BE OVER WRITTEN - GO TO THE AWS-ADDITIONAL-CONFIGS DIRECTORY TO EDIT THE FOLLOWING FILES: 
  - EKS-CLUSTER-ONLY-LINUX.TF
  - EKS-CLUSTER-WINDOWS.TF
