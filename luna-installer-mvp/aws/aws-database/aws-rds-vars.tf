...
variable "vpc-id" {
  type        = string
  description = "The id of the VPC where the infrastructure is getting deployed."
}

variable "vpc-cidr" {
  type        = string
  description = "The CIDR of the VPC where the infrastructure is getting deployed."
}
